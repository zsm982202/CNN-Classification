...
if __name__ == '__main__':
    ...
    traindata_path = 'D:\\python_workspace\\pytorch\\CNN-Classification\\data\\train'
    labels = os.listdir(traindata_path)
    valdata_path = 'D:\\python_workspace\\pytorch\\CNN-Classification\\data\\val'
    ##写train.txt文件
    txtpath = 'D:\\python_workspace\\pytorch\\CNN-Classification\\data\\'
    # print(labels)
