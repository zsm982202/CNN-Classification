...
from data.transform import get_train_transform, get_test_transform

import sys
sys.path.append("..")
import cfg

from data.random_eraser import get_random_eraser
...
class SelfCustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img, torch.from_numpy(np.array(
            int(label))).to(dtype=torch.int64)
